import 'package:flutter/material.dart';
 ...
 Color primary = const Color(0xff3e5f3d);

class Styles {
  static Color primaryColor = primary;
  static Color textColor = const Color(0xFF3b3b3b);
  static Color bgColor = const Color(0xffab9eda);
  static Color orangeColor = const Color(0xFFF367D2);
  ...
  static TextStyle headLineStyle3 = TextStyle(fontSize: 17, color: Colors.grey.shade900, fontWeight: FontWeight.w500);
